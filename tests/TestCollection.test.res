...
zora("Collection", async t => {
  t->test("retreival functions", async t => {
    ...
    t->test("count function", async t => {
      ...
      t->test("first function", async t => {
        let first = await collection
        ->Collection.clone
        ->Collection.first
      ...
      t->test("last function", async t => {
        let last = await collection
        ->Collection.clone
        ->Collection.last
      ...
      t->test("sortBy function", async t => {
        let array = await collection
        ->Collection.clone
  ...
  t->test("mutation functions", async t => {
    t->test("delete function", async t => {
      let dexie = setup()
  ...
  t->test("Collection operation functions (they return self)", async t => {
    ...
    {await dexie ->Friend.bulkPut([
      ...
      t->test("Offset function", async t => {
        let array = await collection
        ->Collection.clone
        ->Collection.offset(2)
        ->Collection.toArray
